...
<!-- docs/{analysis,requirements,design}/ への変更が必要なら明記。Aggregate の追加・削除は design/domain-model.md を同 PR で更新する。 -->

- `docs/design/domain-model.md` への変更: ...
- `docs/design/tech-stack.md` への変更: ...
- 既存 feature への波及: ...
