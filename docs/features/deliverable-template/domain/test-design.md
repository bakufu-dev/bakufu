...
<!-- 対象範囲: REQ-DT-001〜006 / MSG-DT-001〜005 / 親 spec §9 受入基準 / 詳細設計 §確定 A〜E / 4 不変条件 + RoleProfile 1 不変条件 + VO 3 種 -->
...
- **4 不変条件 helper 全種**（schema_format / composition_self_ref / version_non_negative / acceptance_criteria_empty_description）が独立 unit ケースで網羅
