...
<!-- 対象範囲: REQ-GT-001〜006 / MSG-GT-001〜007 / 親 spec §9 受入基準 1〜12 / 詳細設計 §確定 A〜K / state machine 7 遷移 + 5 不変条件 + audit_trail append-only + snapshot 不変 + record_view 冪等性なし + auto-mask -->
...
- 親 spec 受入基準 1〜12 すべてに unit/integration ケース（14/15 は system-test-design.md / repository/test-design.md で管理、frozen・CI 品質基準は内部品質基準）
