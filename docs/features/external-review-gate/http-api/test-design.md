...
- `backend/tests/integration/test_external_review_gate_http_api/test_boundary_static.py`: TC-STATIC-ERG-HTTP-003。`app.py` / `dependencies.py` にトップレベル公開関数定義が残っていないことを検証する。
