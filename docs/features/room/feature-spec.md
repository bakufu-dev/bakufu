...
E2E（受入基準 16, 17）は [`system-test-design.md`](system-test-design.md) で詳細凍結。受入基準 1〜14 は domain sub-feature の IT / UT で検証（[`domain/test-design.md`](domain/test-design.md)）。受入基準 18 は repository IT（TC-IT-RR-008）と E2E（TC-E2E-RM-003）の両方で検証。受入基準 19〜31, 38〜39 は http-api sub-feature の IT で検証（[`http-api/test-design.md`](http-api/test-design.md)）。受入基準 40 は directive http-api sub-feature の IT で検証（[`../../directive/http-api/test-design.md`](../../directive/http-api/test-design.md)）。受入基準 32〜37 は deliverable-template/room-matching sub-feature の IT で検証（[`../../deliverable-template/room-matching/test-design.md`](../../deliverable-template/room-matching/test-design.md)）。
