...
<!-- 対象範囲: REQ-RM-001〜006 / MSG-RM-001〜007 / 脅威 T1, T2 / 受入基準 1〜15 / 詳細設計 確定 A〜H / archive 冪等性 / leader 必須性 と Workflow 参照整合性 と Agent 存在検証 と name 一意の application 層責務境界 -->
...
- 受入基準 1〜15 すべてに unit/integration ケース（16/17 は system-test-design.md の E2E、18 は repository/test-design.md が担当）
...
- 受入基準 1〜15 はすべて unit/integration テストで検証可能
