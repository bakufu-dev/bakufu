...
> 関連: [`feature-spec.md`](feature-spec.md) §9 受入基準 10（11 は repository IT）
...
- TC-E2E-DR-003: HTTP API 経由での Directive 発行（`directive/http-api/` 完成後）
...
- TC-E2E-DR-003, 004 は将来の sub-feature 追加時に本書を更新する別 PR で起票
