...
| `Directive.text` | `directives` | `infrastructure/persistence/sqlite/tables/directives.py` | `MaskedText` | `feature/directive-repository`（Issue #34、**directive §確定 G 実適用済み**、persistence-foundation #23 で hook 構造提供 → 本 PR で配線完了） |
