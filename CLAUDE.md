...
| 順 | パス | 役割 |
|----|----|----|
| 1 | [`docs/architecture/context.md`](docs/architecture/context.md) | システムコンテキスト・アクター・主要ユースケース・スコープ |
| 2 | [`docs/architecture/domain-model.md`](docs/architecture/domain-model.md) | Aggregate / Entity / VO / Domain Event / モジュール配置 |
| 3 | [`docs/architecture/tech-stack.md`](docs/architecture/tech-stack.md) | 採用 / 不採用ツールと根拠 |
| 4 | [`docs/architecture/mvp-scope.md`](docs/architecture/mvp-scope.md) | MVP の In/Out スコープ・マイルストーン |
...
- **CODEOWNERS 保護パスは改変前にオーナー確認**:
  ...
  - `/.github/` / `/docs/architecture/` / `/docs/features/`
...
[`docs/architecture/context.md §10 ai-team 開発室との運用合意`](docs/architecture/context.md) より、MVP M1 の着手順：
